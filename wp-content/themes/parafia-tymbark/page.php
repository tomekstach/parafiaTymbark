<?php
    ...
    function custom_astra_content_loop()
    {
        ...
        if ($pageAlias === 'intencje-piekielko') {
            ...
            // Get all posts which has type 'intencja-mszalna' and has the ACF field 'data' in the ACF field 'intencje_piekielko' equal to the month and year using standard mysql query
